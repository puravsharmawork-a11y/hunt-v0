...
export function JobGridCard({ job, matchData, isSelected, onClick, isSaved, onSave }) {
  ...
  // Logo glyph — first char of the company name, brutalist mono cap
  ...
  return (
    <div
      ...
      style={{
        padding: '18px 20px',
        cursor: 'pointer',
        borderColor: isSelected ? 'var(--ink)' : 'var(--border-mid)',
        boxShadow: isSelected ? '4px 4px 0 0 var(--ink)' : 'none',
    ...
    >
      ...
      {/* Skills (matched chips highlighted blue-tint) */}
